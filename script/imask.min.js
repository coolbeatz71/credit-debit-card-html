      ...
      return (
        J(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              for (
                var u = new ft(), n = this.clone(), r = void 0, i = 0;
                i < t.length;
                ++i
              ) {
                var s = t[i],
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var e = this.unmaskedValue,
                ...
                n = t();
              return (
                this.resolve(u) !== u && (this.unmaskedValue = e),
                  ...
                  ? (c &&
                    ...
                    c
                      ...
                      : (o.optional ||
                          e.input ||
                          this.lazy ||
                          ((this._value += this.placeholderChar), (h = !1)),
                        h || (o.isHollow = !0)))
                  : ((this._value += o.char),
                    (l = c && (o.unmasking || e.input || e.raw) && !e.tail),
                    (o.isRawInput = l && (e.raw || e.input)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var i = 0; i < t.length; ++i) {
                ...
                if (
                  (l && l.stopAlign && e.aggregate(this._appendPlaceholder(a)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                for (
                  l = ot(i, u);
                  0 <= l && l < this._charDefs.length;
                  i += u, l += u
                ) {
                  var h = this._charDefs[l];
                  if (null == s && h.isInput && ((s = i), e === at.NONE)) break;
                  if (
                    (null == o && h.isHollow && !h.isHiddenHollow && (o = i),
              ...
              if (
                ...
                for (
                  ...
                  if (f.isInput && ((s = i), f.isHollow && !f.isHiddenHollow))
                    break;
        ...
        J(e, [
            ...
            value: function () {
              ...
              (this._numberRegExpInput = new RegExp("^" + t + u)),
                ...
                (this._mapToRadixRegExp = new RegExp(
                  "[" + this.mapToRadix.map(lt).join("") + "]",
                  "g",
                )),
                (this._thousandsSeparatorRegExp = new RegExp(
                  lt(this.thousandsSeparator),
                  "g",
                ));
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              for (var o = n + a.inserted.length, l = 0; l <= o; ++l)
                this.value[l] === this.thousandsSeparator &&
                  ((l < n || (l === n && u[l] === this.thousandsSeparator)) &&
                    ++n,
                  l < o && ++o);
              return (
